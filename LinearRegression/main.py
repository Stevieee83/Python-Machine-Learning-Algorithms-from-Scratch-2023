...
# Creates the Linear Regression algorithm and stores it in the model object
model = LinearRegression(X_train, y_train)

# Fits the data to the Linear Regression algorithm during training
model.fit()

# Runs the Linear Regression model in inference mode and stores the predictions in the y_pred Python variable
